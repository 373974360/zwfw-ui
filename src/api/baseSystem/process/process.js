...
export function getOtherSetting(processDefinitionId,
    ...
    return fetch({
        url: '/api/yl12345/process/getOtherSetting',
        method: 'get',
        params: data
    });
}
...
export function saveOtherSetting(data) {
    return fetch({
        url: '/api/yl12345/process/saveOtherSetting',
        method: 'post',
        params: data
    });
}
...
export function getTaskUsers(processDefinitionId, taskDefinitionKey) {
    ...
    return fetch({
        url: '/api/yl12345/process/getTaskUsers',
        method: 'get',
        params: data
    });
}
...
export function saveCandidateUser(processDefinitionId,
    ...
    return fetch({
        url: '/api/yl12345/process/saveCandidateUser',
        method: 'post',
        params: data
    });
}
...
export function getProcessList() {
    return fetch({
        url: '/api/yl12345/process/getProcessList',
        method: 'get'
    })
}
...
export function getProcessVersionList(processDefinitionKey) {
    ...
    return fetch({
        url: '/api/yl12345/process/getProcessVersionList',
        method: 'get',
        params: data
    });
}
...
export function getUserList() {
    const data = {}
    return fetch({
        url: '/api/yl12345/process/getUserList',
        method: 'get',
        params: data
    });
}
