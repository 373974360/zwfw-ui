...
export function getZwfwActivitiModelList(query) {
    return fetch({
        url: '/api/yl12345/activiti/model/list',
        method: 'get',
        params: query
    });
}
...
export function getZwfwActivitiModelUploadUrl() {
    return '/api/yl12345/activiti/model/upload';
}
...
export function createZwfwActivitiModel(data) {
    return fetch({
        url: '/api/yl12345/activiti/model/add',
        method: 'post',
        params: data
    });
}
...
export function deleteZwfwActivitiModel(id) {
    ...
    return fetch({
        url: '/api/yl12345/activiti/model/delete',
        method: 'post',
        params: data
    });
}
...
export function deployZwfwActivitiModel(id) {
    const data = {id: _.isArray(id) ? id.join('#') : id};
    return fetch({
        url: '/api/yl12345/activiti/model/deploy',
        method: 'post',
        params: data
    });
}
...
export function getZwfwProcessDefinitionList(query) {
    return fetch({
        url: '/api/yl12345/activiti/pd/list',
        method: 'get',
        params: query
    });
}
...
export function suspendZwfwProcessDefinition(id) {
    ...
    return fetch({
        url: '/api/yl12345/activiti/pd/suspend',
        method: 'post',
        params: data
    })
}
...
export function activeZwfwProcessDefinition(id) {
    ...
    return fetch({
        url: '/api/yl12345/activiti/pd/active',
        method: 'post',
        params: data
    })
}
...
export function deleteZwfwProcessDefinition(id) {
    ...
    return fetch({
        url: '/api/yl12345/activiti/pd/delete',
        method: 'post',
        params: data
    })
}
