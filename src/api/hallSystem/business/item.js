...
export function getZwfwItemList(query) {
    return fetch({
        url: '/api/hallSystem/business/item/list',
        method: 'get',
        params: query
    });
}
...
export function createZwfwItem(zwfwItemVo) {
    ...
    return fetch({
        url: '/api/hallSystem/business/item/add',
        method: 'post',
        data
    })
}
...
export function updateZwfwItem(zwfwItemVo) {
    const data = zwfwItemVo;
    return fetch({
        url: '/api/hallSystem/business/item/edit',
        method: 'post',
        data
    })
}
...
export function delZwfwItems(ids) {
    const data = {ids};
    return fetch({
        url: '/api/hallSystem/business/item/dels',
        method: 'post',
        data
    });
}
...
export function deleteZwfwItem(id) {
    const data = {id};
    return fetch({
        url: '/api/hallSystem/business/item/delete',
        method: 'post',
        data
    });
}
...
export function getAllByNameOrbasicCode(query) {
    ...
    query.enable = 1;
    return fetch({
        url: '/api/hallSystem/business/item/getAll',
        method: 'get',
        params: query
    })
}
...
export function getPretrialUserListByItemId(itemId) {
    ...
    return fetch({
        url: '/api/hallSystem/business/item/getPretrialUser',
        method: 'get',
        params: data
    });
}
...
export function updatePretrialUserList(itemId, userIds) {
    ...
    return fetch({
        url: '/api/hallSystem/business/item/updatePretrialUser',
        method: 'post',
        params: data
    });
}
...
export function getDetailById(id) {
    return fetch({
        url: '/api/hallSystem/business/item/get',
        method: 'get',
        params: {id}
    })
}
...
export function getItemConfig(itemId) {
    return fetch({
        url: '/api/hallSystem/item/getPreorderconfig',
        method: 'get',
...
export function setItemConfig(zwfwItemConfig) {
    ...
    return fetch({
        url: '/api/hallSystem/item/setPreorderconfig',
        method: 'post',
        params: data
    })
}
