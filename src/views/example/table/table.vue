<template>
  <div class="app-container calendar-list-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="sysMenu" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="重要性">
          <el-rate style="margin-top:8px;" v-model="sysMenu.importance" :colors="['#99A9BF', '#F7BA2A', '#FF9900']"></el-rate>
        </el-form-item>

        <el-form-item label="点评">
          <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容" v-model="sysMenu.remark">
          </el-input>
        </el-form-item>
      </el-form>
