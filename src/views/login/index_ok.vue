                ...
                <el-row type="flex" justify="center">
                    <el-col :span="24">
                        <el-form-item prop="captcha">
                            ...
                            <el-input name="" type="text" v-model="loginForm.captcha" @keyup.enter.native="handleLogin" placeholder="验证码"></el-input>
                            <img class="captcha" src="http://localhost:7777//base/getVerifyCode" alt="验证码不见了">
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row type="flex" justify="center">
