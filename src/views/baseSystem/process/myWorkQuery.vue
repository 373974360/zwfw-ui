<template>
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            <el-input @keyup.enter.native="getList" style="width: 300px;" class="filter-item" placeholder="办件名称"
        ...
        <el-dialog class="s-dialog-title" :title="textMapTitle" :visible.sync="dialogFormVisible"
            ...
            <el-form label-position="right" label-width="200px" label-suffix="：" v-loading="dialogLoading"
                ...
                <el-form-item label="附件列表" prop="description">
                    <el-col :span="15">
                        <template v-for="att in itemProcessAttachmentList">
                            <a v-if="att.remark != 'apply'" class="el-upload-list__item-name" :href="att.fileUrl" :download="att.fileName" target="_blank">
                ...
                <template v-for="h in history" v-if="itemProcessVo.status == 15">
                    ...
                    <el-form-item label="答复附件" prop="description">
                        <el-col :span="15">
                            <template v-for="att in itemProcessAttachmentList">
                                <a v-if="att.remark == 'apply'" class="el-upload-list__item-name" :href="att.fileUrl" :download="att.fileName" target="_blank">
                                    <i class="el-icon-document"></i>{{att.fileName}}</a>
    ...
    export default {
        ...
        methods: {
            ...
            showDetail(row) {
                ...
                this.itemProcessAttachmentList = []
