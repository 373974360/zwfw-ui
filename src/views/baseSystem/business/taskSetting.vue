...
//                                        _this.task.taskCandidateUsers = c.taskCandidateUsers;
            ...
            ActivitiRest.options = {
                processInstanceHighLightsUrl: "/api/yl12345/activiti/service/process-instance/{processInstanceId}/highlights?callback=?",
                processDefinitionUrl: "/api/yl12345/activiti/service/process-definition/{processDefinitionId}/diagram-layout?callback=?",
                processDefinitionByKeyUrl: "/api/yl12345/activiti/service/process-definition/{processDefinitionKey}/diagram-layout?callback=?"
            };
